...
let dir = __dirname;
while(dir[dir.length-1] !== "/"[0] ){
    dir = dir.slice(0, -1);
}
dir = dir.slice(0, -1);
if(Options[1] === "raylib"){
    const raylib_path = dir+"/Libraries/raylib/src";
    project.addIncludeDir(raylib_path);
    project.addIncludeDir(dir+"/Libraries/raylib/src/external");
    project.addIncludeDir(dir+"/Libraries/raylib/src/external/glfw/include/GLFW");
    ...
    project.setCStd('c11');
    const GLFW_path = dir+"/Libraries/raylib/src/external/glfw/src/";
    project.addFiles(
...
project.addIncludeDir(dir+"/Sources");
